module "eks" {
  source                   = "git::https://github.com/windevopscloud/iac_terraform_modules.git//eks?ref=v1.0.24"
...
module "eks_addons" {
  source = "git::https://github.com/windevopscloud/iac_terraform_modules.git//eks_addons?ref=v1.0.24"
